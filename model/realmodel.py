...
class RDN(nn.Module):
    def __init__(self, args, nDenselayer, inChannel, outChannel):
        ...
        self.args = args
        # F-1
        self.conv1 = nn.Conv2d(inChannel, outChannel, kernel_size=1, padding=0, bias=True)
        # F0
        ...
        self.GFF_1x1 = nn.Conv2d(nFeat*3, outChannel, kernel_size=1, padding=0, bias=True)
    def forward(self, x):
...
class CENet(nn.Module):
    def __init__(self, args):
        ...
        self.RDN1 = RDN(args, args.nDenselayer1, args.inChannel1, args.dof) 
        #primary data feature extract layers
        self.RDN2 = RDN(args, args.nDenselayer2, args.inChannel2, args.dof) 
        #secondary data feature extract layers
        self.RDN3 = RDN(args, args.nDenselayer3, args.inChannel3, args.dof*2) 
        #Covariance estiamtion layers
        self.RDN_EC = RDN(args, args.nDenselayer, args.dof*4, args.dof*2) 
        # global feature fusion (GFF)
